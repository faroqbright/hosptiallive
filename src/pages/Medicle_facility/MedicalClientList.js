...
function MedicalClientlist() {
  ...
  useEffect(() => {
    if (productData !== null) {
      dispatch(AllRedux.medicalFacilityByID({ medical_id: productData }));
    }
  ...
  useEffect(() => {
    const fetchToken = async () => {
      try {
        ...
        //
        addLogMessage(
          "An error occurred. See your browser   for more information."
        );
      }
    };
  ...
  // const baseUrl =  `${https://ihcms.s3.amazonaws.com/Medical/}`
  ...
  const data = useSelector(
    (state) => state.managemedical.manageMedicalListing.data.data
  );
console.log("data",data);
  ...
  const removeLeadItem = (rid) => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        dispatch(
          ManageMedical.deleteMedicalClient({ medical_client_id: rid })
        ).then((res) => {
          dispatch(
            ManageMedical.medicalClientListing({ medical_id: productData })
          );
        });
      }
    });
  ...
  useEffect(() => {
    dispatch(ManageMedical.medicalClientListing({ medical_id: productData }));
  }, []);
  ...
  const UploadData = async () => {
    try {
      ...
      const res = await dispatch(
        AllRedux.medicalFacilityDocument({
          medical_id: productData,
    ...
    if (input) {
      html2canvas(input)
        .then((canvas) => {
          ...
          const imgY = 30;
          pdf.setFontSize(20);
          pdf.text("Medical Facility Client List", pdfWidth / 2, 20, { align: "center" });
          pdf.addImage(
            imgData,
            "PNG",
            imgX,
          ...
          pdf.save("medical-facility-client-list.pdf");
        })
        .catch((error) => {
  ...
  const sendDataToEmail = () => {
    try {
      ...
      const medicalFacilityClinetData = {
        tableData : tableData,
        listName  : "Medical Facility Client List"
      }
      if (medicalFacilityClinetData) {
        dispatch(
          AllRedux.sendMedicalFacilityClientEmailData({
           data : medicalFacilityClinetData
          })
        ).then((res) => {
          ...
          <div className="page-body">
            <div className="container-fluid">
              <div className="page-title">
                <div className="row">
                  <div className="col-6">
                    <h4>Manage Medical Facility Client List</h4>
                  </div>
                  <div className="col-6">
                    <ol className="breadcrumb">
                      ...
                      <li className="breadcrumb-item active">
                        Manage Medical Facility Client List
                      </li>
                    </ol>
                  </div>
                </div>
                ...
                <div className="col-sm-12">
                  <div className="card">
                    <div className="card-header">
                      <h4>Add Medical Facility Reports</h4>
                    </div>
                    <div className="card-body">
                      ...
                      >
                        ...
                        <div className="col-md-4 position-relative mx-2">
                          <label
                            className="form-label"
                            htmlFor="validationTooltipUsername"
                          >
                        ...
                        <div className="col-md-3 position-relative">
                          ...
                          <input
                            ...
                            readOnly
                            value={IDData?.hours_operation}
                          />
                        </div><div className="col-md-3 position-relative">
                          <label
                            className="form-label"
                            htmlFor="validationTooltip01"
                          >
                        ...
                        <div {...getRootProps()} className="dropzone">
                          <input {...getInputProps()} />
                          <p>
                            Drag and drop Word (.doc, .docx) or PDF (.pdf) files
                            ...
                            {IDData?.documentData?.map((data, index) => (
                              <li>
                                ...
                                <button
                                  ...
                                  onClick={() => {
                                    dispatch(
                                      AllRedux.deleteMedicalFacilityDocument({
                                        id: data?.id,
                          ...
                          <div className="row">
                            <div className="col-sm-12">
                              ...
                              <button className="btn btn-info me-3">
                                <CSVLink
                                  data={exportCSVData()} 
                                  filename="medical-facility-client-list.csv"
                                  className="text-dark"
                                  target="_blank" 
                                >
                                  Download CSV
...
export default MedicalClientlist;
